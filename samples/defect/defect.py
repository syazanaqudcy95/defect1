...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python defect.py train --dataset=dataset --weights=coco

    # Resume training a model that you had trained earlier
    python defect.py train --dataset=dataset --weights=last
...
class DefectConfig(Config):
    """Configuration for training on the defect dataset.
...
class DefectDataset(utils.Dataset):
    ...
    def load_defect(self, dataset_dir, subset):
        ...
        """
        # Add classes. We have two classes part and DLAM for now
